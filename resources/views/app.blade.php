...
//fetch() yaitu ambil data dari server atau backend
//contohnya axios
...
try{
    ...
    roomId.addEventListener('change', function(){
        ...
        //menampilkan harga di rangkuman pembayaran
...
// jika checkin dan checkout ada isinya
        if(checkin && checkout && checkout > checkin){
            ...
            //menyimpan value ke input hidden
    ...
    document.getElementById('save').addEventListener('click', async function(e){
        ...
        const totalNight = document.querySelector('#totalNightVal').value;
