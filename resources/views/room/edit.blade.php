            ...
            <div class="card-body">
                ...
                <form action="{{route('room.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="category_i d" id="" class="form-control">
                    ...
                    <div class="mb-3">
                     ...
                     <div class="mb-3">
                        ...
                        <input type="number" name="price" class="form-control" placeholder="Masukkan kang kamar" required value="{{$edit->price ?? ''}}">
                    </div>
                     <div class="mb-3">
